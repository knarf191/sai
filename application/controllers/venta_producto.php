...
class Venta_producto extends CI_Controller {
    ...
    {
        $data = $this->consultas->getProductosVenta();
        /*$user = $this->session->userdata('user');
        $data_vale = $this->consultas->getPermisosById($user, "vales");*/
                
        
        $html = '';
        $html .= '<div class="page-header"><h1>Control de Ventas por Producto</h1></div>'; 
            $html .= '<div class="content-principal-section">';
                ...
                $html .= '<table id="table_producto" class="display data_table2">';
                        $html .= '<thead>';
                            $html .= '<tr>';
                                $html .= '<th>ID</th>';
