			...
			<div class="main-inner">
				<div class="sidebar">
					<div class="shortcuts"> </div>
						...
						<?php
						$data = $this->consultas->getPermisosById($user);
						$chofer     = $data['chofer'];
				        ...
				        {
				        	echo'<li>
								<a class="" href="#" id="btn_inventario_chofer">
									<i class="fa fa-truck"></i>
									<span > Inventario Chofer</span>
								</a>
							</li>';
				        }
				        	...
				        	echo'<li class="submenu">
								...
								<ul class="children">
									<li>
										<a href="#" id="btn_stock">
											<span>
												<i class="fa fa-check-square-o" ></i> Stock
											</span>
										</a>
									</li>	
									<li>
										<a href="#" id="btn_produccion">
											<span>
												<i class="fa fa-tachometer"></i> Producción
											</span>
										</a>
									</li>	
								</ul>
				        ...
				        if($ventas==='true')
				        {
				        	echo'<li class="submenu">
								...
								<ul class="children">
									<li>
										<a href="#" id="btn_tienda">
											<span>
												<i class="fa fa-home" ></i> Tienda
											</span>
										</a>
									</li>	
									<li>
										<a href="#" id="btn_producto">
											<span>
												<i class="fa fa-tags"></i> Producto
											</span>
										</a>
									</li>	
								</ul>
